...
def validate_documents(
    ...
    require("codex login status" in tools and "不得再次在聊天里索要 API key" in tools and "codex login --device-auth" in tools, "Codex 登录失效缺少小白安全恢复")
    ...
    require("Select a platform to configure:" in weixin and "不是本 Skill 的 V7.5.15 直达路线" in weixin, "缺少误入全平台菜单的安全恢复")
